...
public class LinearSmoothScroller extends SeslRecyclerView.SmoothScroller {
    ...
    public PointF computeScrollVectorForPosition(int targetPosition) {
        ...
        LogUtils.w(TAG, "You should override computeScrollVectorForPosition when the LayoutManager" + " does not implement " + ScrollVectorProvider.class.getCanonicalName());
        return null;
    }
}
