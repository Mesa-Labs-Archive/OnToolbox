...
public class SeslColorPicker extends LinearLayout {
    ...
    private void initCurrentColorView() {
        ...
        if (this.mIsLightTheme) {
            var2 = R.color.sesl_color_picker_selected_color_item_text_color_light;
        } else {
    ...
    private void initOpacitySeekBar() throws Throwable {
        ...
        this.mOpacitySeekBar.setOnSeekBarChangeListener(new SeslSeekBar.OnSeekBarChangeListener() {
    ...
    private void initRecentColorLayout() {
        ...
        int var2;
        if (this.mIsLightTheme) {
            var2 = R.color.sesl_color_picker_used_color_item_empty_slot_color_light;
        } else {
            var2 = R.color.sesl_color_picker_used_color_item_empty_slot_color_dark;
        }

        int var3 = ContextCompat.getColor(var1, var2);
        ...
        var1 = this.mContext;
        if (this.mIsLightTheme) {
            var2 = R.color.sesl_color_picker_used_color_text_color_light;
        } else {
    ...
    private void setImageColor(View var1, Integer var2) {
        ...
        int var4;
        if (this.mIsLightTheme) {
            var4 = R.drawable.sesl_color_picker_used_color_item_slot_light;
        } else {
            var4 = R.drawable.sesl_color_picker_used_color_item_slot_dark;
        }

        GradientDrawable var5 = (GradientDrawable)var3.getDrawable(var4);
        if (var2 != null) {
            var5.setColor(var2);
        }
