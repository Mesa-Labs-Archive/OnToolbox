...
@SeslCoordinatorLayout.DefaultBehavior(SeslAppBarLayout.Behavior.class)
public class SeslAppBarLayout extends LinearLayout implements ABLBehavior {
    ...
    public List<SeslAppBarLayout.BaseOnOffsetChangedListener> mListeners;
    public int mPendingAction;
    public int[] mTmpStatesArray;
    public int mTotalScrollRange;

    public SeslAppBarLayout(Context var1) {
        this(var1, (AttributeSet)null);
    }

    public SeslAppBarLayout(Context var1, AttributeSet var2) {
        this(var1, var2, 0);
    }

    @SuppressLint({"WrongConstant", "RestrictedApi"})
    public SeslAppBarLayout(Context var1, AttributeSet var2, int var3) {
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            ViewUtilsLollipop.setStateListAnimatorFromAttrs(this, var2, var3, R.style.mesa_AppBarLayoutStyle);
        }

        TypedArray var4 = ThemeEnforcement.obtainStyledAttributes(var1, var2, R.styleable.SeslAppBarLayout, var3, R.style.mesa_AppBarLayoutStyle, new int[0]);
        if (var4.hasValue(R.styleable.SeslAppBarLayout_android_background)) {
            this.mBackground = var4.getDrawable(R.styleable.SeslAppBarLayout_android_background);
            ViewCompat.setBackground(this, this.mBackground);
        } else {
            this.mBackground = null;
            if (this.isLightTheme()) {
                this.setBackgroundColor(this.getResources().getColor(R.color.sesl_action_bar_background_color_light, null));
            } else {
                this.setBackgroundColor(this.getResources().getColor(R.color.sesl_action_bar_background_color_dark, null));
            }
        }

        if (var4.hasValue(R.styleable.SeslAppBarLayout_expanded)) {
            this.setExpanded(var4.getBoolean(R.styleable.SeslAppBarLayout_expanded, false), false, false);
        }

        if (Build.VERSION.SDK_INT >= 21 && var4.hasValue(R.styleable.SeslAppBarLayout_elevation)) {
            ViewUtilsLollipop.setDefaultAppBarLayoutStateListAnimator(this, (float)var4.getDimensionPixelSize(R.styleable.SeslAppBarLayout_elevation, 0));
        }

        if (var4.hasValue(R.styleable.SeslAppBarLayout_sesl_layout_heightPercent)) {
            this.mHeightCustom = var4.getFloat(R.styleable.SeslAppBarLayout_sesl_layout_heightPercent, 0.3967F);
        } else {
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            if (var4.hasValue(R.styleable.SeslAppBarLayout_android_keyboardNavigationCluster)) {
                this.setKeyboardNavigationCluster(var4.getBoolean(R.styleable.SeslAppBarLayout_android_keyboardNavigationCluster, false));
            }

            if (var4.hasValue(R.styleable.SeslAppBarLayout_android_touchscreenBlocksFocus)) {
                this.setTouchscreenBlocksFocus(var4.getBoolean(R.styleable.SeslAppBarLayout_android_touchscreenBlocksFocus, false));
            }
        }

        this.liftOnScroll = var4.getBoolean(R.styleable.SeslAppBarLayout_liftOnScroll, false);
        this.liftOnScrollTargetViewId = var4.getResourceId(R.styleable.SeslAppBarLayout_liftOnScrollTargetViewId, -1);
        var4.recycle();
        if (this.mBottomPadding > 0) {
            ...
            mAppBarHeight = (float)this.getResources().getDimensionPixelSize(R.dimen.sesl_material_action_bar_default_height);
        }

        ViewCompat.setOnApplyWindowInsetsListener(this, new androidx.core.view.OnApplyWindowInsetsListener() {
            public WindowInsetsCompat onApplyWindowInsets(View var1, WindowInsetsCompat var2) {
                return SeslAppBarLayout.this.onWindowInsetChanged(var2);
            }
        });
    ...
    public void addOnOffsetChangedListener(SeslAppBarLayout.BaseOnOffsetChangedListener var1) {
    ...
    public void addOnOffsetChangedListener(SeslAppBarLayout.OnOffsetChangedListener var1) {
        this.addOnOffsetChangedListener((SeslAppBarLayout.BaseOnOffsetChangedListener)var1);
    }

    public boolean checkLayoutParams(android.view.ViewGroup.LayoutParams var1) {
        return var1 instanceof SeslAppBarLayout.LayoutParams;
    }
    ...
    public void dispatchOffsetUpdates(int var1) {
        ...
        if (var2 != null) {
            ...
            for(int var4 = var2.size(); var3 < var4; ++var3) {
                SeslAppBarLayout.BaseOnOffsetChangedListener var5 = (SeslAppBarLayout.BaseOnOffsetChangedListener)this.mListeners.get(var3);
                if (var5 != null) {
    ...
    public SeslAppBarLayout.LayoutParams generateDefaultLayoutParams() {
        return new SeslAppBarLayout.LayoutParams(-1, -2);
    }

    public SeslAppBarLayout.LayoutParams generateLayoutParams(AttributeSet var1) {
        return new SeslAppBarLayout.LayoutParams(this.getContext(), var1);
    }

    public SeslAppBarLayout.LayoutParams generateLayoutParams(android.view.ViewGroup.LayoutParams var1) {
        if (Build.VERSION.SDK_INT >= 19 && var1 instanceof android.widget.LinearLayout.LayoutParams) {
            return new SeslAppBarLayout.LayoutParams((android.widget.LinearLayout.LayoutParams)var1);
        } else {
            return var1 instanceof MarginLayoutParams ? new SeslAppBarLayout.LayoutParams((MarginLayoutParams)var1) : new SeslAppBarLayout.LayoutParams(var1);
        }
    }
    ...
    public int getDownNestedPreScrollRange() {
        ...
        if (var1 != -1) {
            ...
            for(var3 = 0; var2 >= 0; var3 = var1) {
                ...
                SeslAppBarLayout.LayoutParams var5 = (SeslAppBarLayout.LayoutParams)var4.getLayoutParams();
    ...
    public int getDownNestedScrollRange() {
        ...
        if (var1 != -1) {
            ...
            while(true) {
                ...
                SeslAppBarLayout.LayoutParams var6 = (SeslAppBarLayout.LayoutParams)var5.getLayoutParams();
    ...
    public final boolean hasCollapsibleChild() {
        ...
        for(int var2 = 0; var2 < var1; ++var2) {
            if (((SeslAppBarLayout.LayoutParams)this.getChildAt(var2).getLayoutParams()).isCollapsible()) {
                return true;
            }
        }
    ...
    public void onLayout(boolean var1, int var2, int var3, int var4, int var5) {
        ...
        for(var2 = 0; var2 < var3; ++var2) {
            if (((SeslAppBarLayout.LayoutParams)this.getChildAt(var2).getLayoutParams()).getScrollInterpolator() != null) {
    ...
    public void onMeasure(int var1, int var2) {
        if (!this.mIsSetCollapsedHeight) {
            if (this.mBottomPadding > 0) {
                mAppBarHeight = (float)this.getResources().getDimensionPixelSize(R.dimen.sesl_action_bar_default_height_padding);
            } else {
    ...
    public void removeOnOffsetChangedListener(SeslAppBarLayout.BaseOnOffsetChangedListener var1) {
        List var2 = this.mListeners;
    ...
    public void removeOnOffsetChangedListener(SeslAppBarLayout.OnOffsetChangedListener var1) {
        this.removeOnOffsetChangedListener((SeslAppBarLayout.BaseOnOffsetChangedListener)var1);
    }
    ...
    public void setCollapsedHeight(float var1) {
        ...
        var2.append(var1);
        LogUtils.d("Sesl_AppBarLayout", var2.toString());
    ...
    public final void updateInternalHeight() {
        ...
        var5.append(var4);
        LogUtils.d("Sesl_AppBarLayout", var5.toString());

        SeslCoordinatorLayout.LayoutParams var7;
        try {
            var7 = (SeslCoordinatorLayout.LayoutParams)this.getLayoutParams();
        } catch (ClassCastException var6) {
            LogUtils.e("Sesl_AppBarLayout", Log.getStackTraceString(var6));
            var7 = null;
        }
    ...
    protected static class BaseBehavior<T extends SeslAppBarLayout> extends HeaderBehavior<T> {
        ...
        public SeslAppBarLayout.BaseBehavior.BaseDragCallback onDragCallback;
        public float touchX;
        public float touchY;
        ...
        public static View getAppBarChildOnOffset(SeslAppBarLayout var0, int var1) {
        ...
        public final void animateOffsetTo(SeslCoordinatorLayout var1, T var2, int var3, float var4) {
            int var5;
        ...
        public final void animateOffsetWithDuration(final SeslCoordinatorLayout var1, final T var2, int var3, int var4) {
            ...
            if (var5 == var3) {
                ...
                if (var6 == null) {
                    ...
                    this.offsetAnimator.setInterpolator(SeslAppBarLayout.SINE_OUT_80_INTERPOLATOR);
                    this.offsetAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                        public void onAnimationUpdate(ValueAnimator var1x) {
                            SeslAppBarLayout.BaseBehavior.this.setHeaderTopBottomOffset(var1, var2, (Integer)var1x.getAnimatedValue());
                        }
                    });
                } else {
                    var6.cancel();
        ...
        public boolean canDragView(T var1) {
            SeslAppBarLayout.BaseBehavior.BaseDragCallback var2 = this.onDragCallback;
            if (var2 != null) {
        ...
        public final boolean canScrollChildren(SeslCoordinatorLayout var1, T var2, View var3) {
            boolean var4;
        ...
        public final View findFirstScrollingChild(SeslCoordinatorLayout var1) {
        ...
        public final int getChildIndexOnOffset(T var1, int var2) {
            ...
            for(int var4 = 0; var4 < var3; ++var4) {
                ...
                SeslAppBarLayout.LayoutParams var10 = (SeslAppBarLayout.LayoutParams)var5.getLayoutParams();
                int var8 = var6;
                int var9 = var7;
        ...
        public final int interpolateOffset(T var1, int var2) {
            ...
            for(int var6 = 0; var6 < var4; ++var6) {
                ...
                SeslAppBarLayout.LayoutParams var8 = (SeslAppBarLayout.LayoutParams)var7.getLayoutParams();
        ...
        public final boolean isScrollHoldMode(T var1) {
            if (this.mToolisMouse) {
                ...
                if (var3 >= 0) {
                    var4 = var2;
                    if ((((SeslAppBarLayout.LayoutParams)var1.getChildAt(var3).getLayoutParams()).getScrollFlags() & 65536) == 65536) {
                        var4 = false;
                    }
                }
        ...
        public boolean onLayoutChild(SeslCoordinatorLayout var1, T var2, int var3) {
        ...
        public boolean onMeasureChild(SeslCoordinatorLayout var1, T var2, int var3, int var4, int var5, int var6) {
            if (((SeslCoordinatorLayout.LayoutParams)var2.getLayoutParams()).height == -2) {
        ...
        public boolean onNestedPreFling(SeslCoordinatorLayout var1, T var2, View var3, float var4, float var5) {
            this.mVelocity = var5;
            if (var5 < -300.0F) {
        ...
        public void onNestedPreScroll(SeslCoordinatorLayout var1, T var2, View var3, int var4, int var5, int[] var6, int var7) {
            if (var5 != 0) {
                int var8;
                if (var5 < 0) {
        ...
        @SuppressLint("WrongConstant")
        public void onNestedScroll(SeslCoordinatorLayout var1, T var2, View var3, int var4, int var5, int var6, int var7, int var8) {
        ...
        public void onRestoreInstanceState(SeslCoordinatorLayout var1, T var2, Parcelable var3) {
            if (var3 instanceof SeslAppBarLayout.BaseBehavior.SavedState) {
                SeslAppBarLayout.BaseBehavior.SavedState var4 = (SeslAppBarLayout.BaseBehavior.SavedState)var3;
        ...
        public Parcelable onSaveInstanceState(SeslCoordinatorLayout var1, T var2) {
            ...
            for(int var7 = 0; var7 < var5; ++var7) {
                ...
                if (var9.getTop() + var4 <= 0 && var8 >= 0) {
                    SeslAppBarLayout.BaseBehavior.SavedState var10 = new SeslAppBarLayout.BaseBehavior.SavedState(var3);
        ...
        public boolean onStartNestedScroll(SeslCoordinatorLayout var1, T var2, View var3, View var4, int var5, int var6) {
            boolean var7;
            ...
            if (var2.mLifted) {
                ...
                if (var8 > SeslAppBarLayout.mAppBarHeight) {
                    StringBuilder var10 = new StringBuilder();
                    var10.append("CollapsedHeight is bigger than AppBarHeight :");
                    var10.append(var8);
                    LogUtils.d("Sesl_AppBarLayout", var10.toString());
                    SeslAppBarLayout.mAppBarHeight = var8;
                }
            }

            if ((float)var2.getBottom() <= SeslAppBarLayout.mAppBarHeight) {
                this.mLifted = true;
        ...
        public void onStopNestedScroll(SeslCoordinatorLayout var1, T var2, View var3, int var4) {
        ...
        public boolean onTouchEvent(SeslCoordinatorLayout var1, T var2, MotionEvent var3) {
        ...
        public int setHeaderTopBottomOffset(SeslCoordinatorLayout var1, T var2, int var3, int var4, int var5) {
        ...
        public final boolean shouldJumpElevationState(SeslCoordinatorLayout var1, T var2) {
            List var6 = var1.getDependents(var2);
            int var3 = var6.size();
            boolean var4 = false;

            for(int var5 = 0; var5 < var3; ++var5) {
                SeslCoordinatorLayout.Behavior var7 = ((SeslCoordinatorLayout.LayoutParams)((View)var6.get(var5)).getLayoutParams()).getBehavior();
                if (var7 instanceof SeslAppBarLayout.ScrollingViewBehavior) {
                    if (((SeslAppBarLayout.ScrollingViewBehavior)var7).getOverlayTop() != 0) {
                        var4 = true;
                    }
        ...
        public final void snapToChildIfNeeded(SeslCoordinatorLayout var1, T var2) {
            ...
            if (var4 >= 0) {
                ...
                SeslAppBarLayout.LayoutParams var7 = (SeslAppBarLayout.LayoutParams)var6.getLayoutParams();
                ...
                label63: {
                    if (this.isScrollHoldMode(var2)) {
                        ...
                        var11 = var4;
                        if ((float)var5.getTop() <= SeslAppBarLayout.mAppBarHeight) {
                            break label63;
                        }
        ...
        public final void updateAppBarLayoutDrawableState(SeslCoordinatorLayout var1, T var2, int var3, int var4, boolean var5) {
            View var6 = getAppBarChildOnOffset(var2, var3);
            if (var6 != null) {
                int var7 = ((SeslAppBarLayout.LayoutParams)var6.getLayoutParams()).getScrollFlags();
                boolean var8 = false;
                boolean var9 = var8;
                if ((var7 & 1) != 0) {
                    label51: {
        ...
        public abstract static class BaseDragCallback<T extends SeslAppBarLayout> {
            public abstract boolean canDrag(T var1);
        }

        protected static class SavedState extends AbsSavedState {
            public static final Creator<SeslAppBarLayout.BaseBehavior.SavedState> CREATOR = new ClassLoaderCreator<SeslAppBarLayout.BaseBehavior.SavedState>() {
                public SeslAppBarLayout.BaseBehavior.SavedState createFromParcel(Parcel var1) {
                    return new SeslAppBarLayout.BaseBehavior.SavedState(var1, (ClassLoader)null);
                }

                public SeslAppBarLayout.BaseBehavior.SavedState createFromParcel(Parcel var1, ClassLoader var2) {
                    return new SeslAppBarLayout.BaseBehavior.SavedState(var1, var2);
                }

                public SeslAppBarLayout.BaseBehavior.SavedState[] newArray(int var1) {
                    return new SeslAppBarLayout.BaseBehavior.SavedState[var1];
                }
            };
    ...
    public interface BaseOnOffsetChangedListener<T extends SeslAppBarLayout> {
        void onOffsetChanged(T var1, int var2);
    }

    public static class Behavior extends SeslAppBarLayout.BaseBehavior<SeslAppBarLayout> {
        public Behavior() {
        }
    ...
    public static class LayoutParams extends android.widget.LinearLayout.LayoutParams {
        ...
        public LayoutParams(Context var1, AttributeSet var2) {
            super(var1, var2);
            TypedArray var3 = var1.obtainStyledAttributes(var2, R.styleable.SeslAppBarLayout_Layout);
            this.scrollFlags = var3.getInt(R.styleable.SeslAppBarLayout_Layout_layout_scrollFlags, 0);
            if (var3.hasValue(R.styleable.SeslAppBarLayout_Layout_layout_scrollInterpolator)) {
                this.scrollInterpolator = AnimationUtils.loadInterpolator(var1, var3.getResourceId(R.styleable.SeslAppBarLayout_Layout_layout_scrollInterpolator, 0));
            }
    ...
    public interface OnOffsetChangedListener extends SeslAppBarLayout.BaseOnOffsetChangedListener<SeslAppBarLayout> {
    }
    ...
    public static class ScrollingViewBehavior extends HeaderScrollingViewBehavior {
        ...
        public static int getAppBarLayoutOffset(SeslAppBarLayout var0) {
            SeslCoordinatorLayout.Behavior var1 = ((SeslCoordinatorLayout.LayoutParams)var0.getLayoutParams()).getBehavior();
            return var1 instanceof SeslAppBarLayout.BaseBehavior ? ((SeslAppBarLayout.BaseBehavior)var1).getTopBottomOffsetForScrollingSibling() : 0;
        }

        public SeslAppBarLayout findFirstDependency(List<View> var1) {
            int var2 = var1.size();

            for(int var3 = 0; var3 < var2; ++var3) {
                View var4 = (View)var1.get(var3);
                if (var4 instanceof SeslAppBarLayout) {
                    return (SeslAppBarLayout)var4;
                }
            }
        ...
        public float getOverlapRatioForOffset(View var1) {
            if (var1 instanceof SeslAppBarLayout) {
                SeslAppBarLayout var5 = (SeslAppBarLayout)var1;
        ...
        public int getScrollRange(View var1) {
            return var1 instanceof SeslAppBarLayout ? ((SeslAppBarLayout)var1).getTotalScrollRange() : super.getScrollRange(var1);
        }

        public boolean layoutDependsOn(SeslCoordinatorLayout var1, View var2, View var3) {
            return var3 instanceof SeslAppBarLayout;
        }

        public final void offsetChildAsNeeded(View var1, View var2) {
            SeslCoordinatorLayout.Behavior var3 = ((SeslCoordinatorLayout.LayoutParams)var2.getLayoutParams()).getBehavior();
            if (var3 instanceof SeslAppBarLayout.BaseBehavior) {
                SeslAppBarLayout.BaseBehavior var4 = (SeslAppBarLayout.BaseBehavior)var3;
        ...
        public boolean onDependentViewChanged(SeslCoordinatorLayout var1, View var2, View var3) {
            this.offsetChildAsNeeded(var2, var3);
            this.updateLiftedStateIfNeeded(var2, var3);
            return false;
        }

        public boolean onRequestChildRectangleOnScreen(SeslCoordinatorLayout var1, View var2, Rect var3, boolean var4) {
            SeslAppBarLayout var5 = this.findFirstDependency(var1.getDependencies(var2));
            if (var5 != null) {
        ...
        public final void updateLiftedStateIfNeeded(View var1, View var2) {
            if (var2 instanceof SeslAppBarLayout) {
                SeslAppBarLayout var3 = (SeslAppBarLayout)var2;
