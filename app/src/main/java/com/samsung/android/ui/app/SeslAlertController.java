...
public class SeslAlertController {
    ...
    public final View.OnClickListener mButtonHandler = new View.OnClickListener() {
        public void onClick(View var1) {
            Message var3;
            label33: {
                SeslAlertController var2 = SeslAlertController.this;
                Message var4;
            ...
            SeslAlertController var5 = SeslAlertController.this;
    ...
    public SeslNestedScrollView mScrollView;
    ...
    public SeslAlertController(Context var1, AppCompatDialog var2, Window var3) {
        this.mContext = var1;
        this.mDialog = var2;
        this.mWindow = var3;
        this.mHandler = new SeslAlertController.ButtonHandler(var2);
        TypedArray var4 = var1.obtainStyledAttributes((AttributeSet)null, R.styleable.SeslAlertDialog, R.attr.alertDialogStyle, 0);
        this.mAlertDialogLayout = var4.getResourceId(R.styleable.SeslAlertDialog_android_layout, 0);
        this.mButtonPanelSideLayout = var4.getResourceId(R.styleable.SeslAlertDialog_buttonPanelSideLayout, 0);
        this.mListLayout = var4.getResourceId(R.styleable.SeslAlertDialog_listLayout, 0);
        this.mMultiChoiceItemLayout = var4.getResourceId(R.styleable.SeslAlertDialog_multiChoiceItemLayout, 0);
        this.mSingleChoiceItemLayout = var4.getResourceId(R.styleable.SeslAlertDialog_singleChoiceItemLayout, 0);
        this.mListItemLayout = var4.getResourceId(R.styleable.SeslAlertDialog_listItemLayout, 0);
        this.mShowTitle = var4.getBoolean(R.styleable.SeslAlertDialog_showTitle, true);
        this.mButtonIconDimen = var4.getDimensionPixelSize(R.styleable.SeslAlertDialog_buttonIconDimen, 0);
        var4.recycle();
        ...
        if (Build.VERSION.SDK_INT >= 23) {
            ...
            if (var2 != null || var6 != null) {
                if (this.mMessage != null) {
                    ...
                    this.mScrollView.setOnScrollChangeListener(new SeslNestedScrollView.OnScrollChangeListener() {
                        public void onScrollChange(SeslNestedScrollView var1, int var2x, int var3, int var4, int var5) {
                            SeslAlertController.manageScrollIndicators(var1, finalVar, finalVar1);
                        }
                    });
                    ...
                    this.mScrollView.post(new Runnable() {
                        public void run() {
                            SeslAlertController.manageScrollIndicators(SeslAlertController.this.mScrollView, finalVar2, finalVar3);
                        }
                    });
                } else {
                    var7 = this.mListView;
                    if (var7 != null) {
                        ...
                        var7.setOnScrollListener(new AbsListView.OnScrollListener() {
                            public void onScroll(AbsListView var1, int var2x, int var3, int var4) {
                                SeslAlertController.manageScrollIndicators(var1, finalVar4, finalVar5);
                            }
                        ...
                        this.mListView.post(new Runnable() {
                            public void run() {
                                SeslAlertController.manageScrollIndicators(SeslAlertController.this.mListView, finalVar6, finalVar7);
                            }
                        });
                    } else {
                        if (var2 != null) {
    ...
    private void setupButtons(ViewGroup var1) {
        ...
        if (Build.VERSION.SDK_INT > 26) {
            if (var10.resourceId > 0) {
                Utils.genericInvokeMethod(this.mButtonPositive, Build.VERSION.SDK_INT >= 29 ? "hidden_semSetButtonShapeEnabled" : "semSetButtonShapeEnabled", var4, var5);
            } else {
        ...
        if (Build.VERSION.SDK_INT > 26) {
            if (var10.resourceId > 0) {
                Utils.genericInvokeMethod(this.mButtonNegative, Build.VERSION.SDK_INT >= 29 ? "hidden_semSetButtonShapeEnabled" : "semSetButtonShapeEnabled", var4, var5);
            } else {
        ...
        if (Build.VERSION.SDK_INT > 26) {
            if (var10.resourceId > 0) {
                Utils.genericInvokeMethod(this.mButtonNeutral, Build.VERSION.SDK_INT >= 29 ? "hidden_semSetButtonShapeEnabled" : "semSetButtonShapeEnabled", var4, var5);
            } else {
    ...
    private void setupContent(ViewGroup var1) {
        this.mScrollView = (SeslNestedScrollView)this.mWindow.findViewById(R.id.scrollView);
    ...
    private void setupView() {
        ...
        var1.addOnLayoutChangeListener(new View.OnLayoutChangeListener() {
            public void onLayoutChange(View var1x, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9) {
                var1x.post(new Runnable() {
                    public void run() {
                        int var1x = SeslAlertController.this.mContext.getResources().getConfiguration().orientation;
                        SeslAlertController var2 = SeslAlertController.this;
        ...
        if (var10 != 0) {
            SeslNestedScrollView var15 = this.mScrollView;
            if (var15 != null) {
        ...
        if (var16 instanceof SeslAlertController.RecycleListView) {
            ((SeslAlertController.RecycleListView)var16).setHasDecor(var10 == 1, var11);
        }
        ...
        if (var16 != null) {
            ...
            if (var21 != null) {
                ...
                if (Build.VERSION.SDK_INT >= 28)
                    Utils.genericInvokeMethod(AdapterView.class, var21, Build.VERSION.SDK_INT >= 29 ? "hidden_semSetBottomColor" : "semSetBottomColor", 0);
    ...
    public boolean onKeyDown(int var1, KeyEvent var2) {
        SeslNestedScrollView var3 = this.mScrollView;
        boolean var4;
    ...
    public static class AlertParams {
        ...
        public SeslAlertController.AlertParams.OnPrepareListViewListener mOnPrepareListViewListener;
        ...
        private void createListView(final SeslAlertController var1) {
            final SeslAlertController.RecycleListView var2 = (SeslAlertController.RecycleListView)this.mInflater.inflate(var1.mListLayout, (ViewGroup)null);
            Cursor var3;
            Object var6;
            if (this.mIsMultiChoice) {
                ...
                if (var3 == null) {
                    ...
                    var6 = new CursorAdapter(this.mContext, var3, false) {
...

                        {
                            ...
                            this.mLabelIndex = var7.getColumnIndexOrThrow(SeslAlertController.AlertParams.this.mLabelColumn);
                            this.mIsCheckedIndex = var7.getColumnIndexOrThrow(SeslAlertController.AlertParams.this.mIsCheckedColumn);
                        }
                        ...
                        public void bindView(View var1x, Context var2x, Cursor var3) {
                            ...
                            SeslAlertController.RecycleListView var7 = var2;
                        ...
                        public View newView(Context var1x, Cursor var2x, ViewGroup var3) {
                            return SeslAlertController.AlertParams.this.mInflater.inflate(var1.mMultiChoiceItemLayout, var3, false);
                        }
                    };
                }
            } else {
                ...
                if (var3 != null) {
                    ...
                    var6 = this.mAdapter;
                    if (var6 == null) {
                        var6 = new SeslAlertController.CheckedItemAdapter(this.mContext, var4, 16908308, this.mItems);
                    }
                }
            }

            SeslAlertController.AlertParams.OnPrepareListViewListener var5 = this.mOnPrepareListViewListener;
            if (var5 != null) {
            ...
            if (this.mOnClickListener != null) {
                var2.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    public void onItemClick(AdapterView<?> var1x, View var2, int var3, long var4) {
                        SeslAlertController.AlertParams.this.mOnClickListener.onClick(var1.mDialog, var3);
                        if (!SeslAlertController.AlertParams.this.mIsSingleChoice) {
                ...
                var2.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    public void onItemClick(AdapterView<?> var1x, View var2x, int var3, long var4) {
                        boolean[] var6 = SeslAlertController.AlertParams.this.mCheckedItems;
                        if (var6 != null) {
                            var6[var3] = var2.isItemChecked(var3);
                        }

                        SeslAlertController.AlertParams.this.mOnCheckboxClickListener.onClick(var1.mDialog, var3, var2.isItemChecked(var3));
                    }
                });
            }
        ...
        public void apply(SeslAlertController var1) {
    ...
    public static class RecycleListView extends ListView {
        ...
        public void setOverScrollMode(int var1) {
            if (var1 != 2) {
                if ((EdgeEffect) Utils.genericGetField(this, Build.VERSION.SDK_INT >= 29 ? "hidden_mEdgeGlowTop" : "mEdgeGlowTop") == null) {
                    Context var2 = this.getContext();
                    SeslEdgeEffect var3 = new SeslEdgeEffect(var2);
                    SeslEdgeEffect var4 = new SeslEdgeEffect(var2);
                    var3.setSeslHostView(this);
                    var4.setSeslHostView(this);

                    Utils.genericSetField(this, Build.VERSION.SDK_INT >= 29 ? "hidden_mEdgeGlowTop" : "mEdgeGlowTop", var3);
                    Utils.genericSetField(this, Build.VERSION.SDK_INT >= 29 ? "hidden_mEdgeGlowBottom" : "mEdgeGlowBottom", var4);
                }
            } else {
                Utils.genericSetField(this, Build.VERSION.SDK_INT >= 29 ? "hidden_mEdgeGlowTop" : "mEdgeGlowTop", (EdgeEffect)null);
                Utils.genericSetField(this, Build.VERSION.SDK_INT >= 29 ? "hidden_mEdgeGlowBottom" : "mEdgeGlowBottom", (EdgeEffect)null);
            }
