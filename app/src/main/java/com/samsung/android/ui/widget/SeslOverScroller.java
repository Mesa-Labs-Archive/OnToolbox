...
public class SeslOverScroller {
    ...
    static class SplineOverScroller {
        ...
        void finish() {
            if (mIsDVFSBoosting) {
                Utils.genericInvokeMethod("com.samsung.android.os.SemPerfManager", "onSmoothScrollEvent", false);
        ...
        void fling(int start, int velocity, int min, int max, int over) {
            ...
            if (velocity != 0) {
                ...
                if (sEnableSmoothFling && !mIsDVFSBoosting && (velocity >= 800 || velocity <= -800)) {
                    Utils.genericInvokeMethod("com.samsung.android.os.SemPerfManager", "onSmoothScrollEvent", true);
