...
public class SeslNestedScrollView extends FrameLayout implements NestedScrollingParent3, NestedScrollingChild3, ScrollingView {
    ...
    public SeslEdgeEffect mEdgeGlowBottom;
    public SeslEdgeEffect mEdgeGlowTop;
    ...
    public SeslNestedScrollView.OnScrollChangeListener mOnScrollChangeListener;
    public final NestedScrollingParentHelper mParentHelper;
    public SeslNestedScrollView.SavedState mSavedState;
    ...
    public SeslNestedScrollView(Context var1) {
        this(var1, (AttributeSet)null);
    }

    public SeslNestedScrollView(Context var1, AttributeSet var2) {
        this(var1, var2, 0);
    }

    public SeslNestedScrollView(Context var1, AttributeSet var2, int var3) {
    ...
    public final boolean canScroll() {
        ...
        if (var1 > 0) {
            ...
            android.widget.FrameLayout.LayoutParams var5 = (android.widget.FrameLayout.LayoutParams)var4.getLayoutParams();
            var3 = var2;
    ...
    public int computeScrollDeltaToGetChildRectOnScreen(Rect var1) {
        ...
        if (var2 == 0) {
            ...
            android.widget.FrameLayout.LayoutParams var9 = (android.widget.FrameLayout.LayoutParams)var8.getLayoutParams();
    ...
    public final void endDrag() {
        ...
        SeslEdgeEffect var1 = this.mEdgeGlowTop;
        if (var1 != null) {
            var1.onRelease();
    ...
    public final void ensureGlows() {
        if (this.getOverScrollMode() != 2) {
            if (this.mEdgeGlowTop == null) {
                ...
                this.mEdgeGlowTop = new SeslEdgeEffect(var1);
                this.mEdgeGlowBottom = new SeslEdgeEffect(var1);
    ...
    public boolean fullScroll(int var1) {
        ...
        if (var2) {
            ...
            if (var6 > 0) {
                ...
                android.widget.FrameLayout.LayoutParams var7 = (android.widget.FrameLayout.LayoutParams)var5.getLayoutParams();
    ...
    public float getBottomFadingEdgeStrength() {
        if (this.getChildCount() == 0) {
            ...
            android.widget.FrameLayout.LayoutParams var2 = (android.widget.FrameLayout.LayoutParams)var1.getLayoutParams();
    ...
    public void onLayout(boolean var1, int var2, int var3, int var4, int var5) {
        ...
        if (!this.mIsLaidOut) {
            ...
            if (this.getChildCount() > 0) {
                ...
                android.widget.FrameLayout.LayoutParams var10 = (android.widget.FrameLayout.LayoutParams)var7.getLayoutParams();
    ...
    public void onRestoreInstanceState(Parcelable var1) {
        if (!(var1 instanceof SeslNestedScrollView.SavedState)) {
            super.onRestoreInstanceState(var1);
        } else {
            SeslNestedScrollView.SavedState var2 = (SeslNestedScrollView.SavedState)var1;
    ...
    public Parcelable onSaveInstanceState() {
        SeslNestedScrollView.SavedState var1 = new SeslNestedScrollView.SavedState(super.onSaveInstanceState());
    ...
    public void onScrollChanged(int var1, int var2, int var3, int var4) {
        ...
        SeslNestedScrollView.OnScrollChangeListener var5 = this.mOnScrollChangeListener;
        if (var5 != null) {
                    ...
                    if (var4 == -1) {
                        ...
                        if (this.mIsBeingDragged) {
                            ...
                            if (var15) {
                                ...
                                SeslEdgeEffect var13 = this.mEdgeGlowTop;
    ...
    public void setOnScrollChangeListener(SeslNestedScrollView.OnScrollChangeListener var1) {
    ...
    public static class AccessibilityDelegate extends AccessibilityDelegateCompat {
        ...
        public void onInitializeAccessibilityEvent(View var1, AccessibilityEvent var2) {
            ...
            SeslNestedScrollView var4 = (SeslNestedScrollView)var1;
        ...
        public boolean performAccessibilityAction(View var1, int var2, Bundle var3) {
            if (super.performAccessibilityAction(var1, var2, var3)) {
                ...
                SeslNestedScrollView var6 = (SeslNestedScrollView)var1;
                if (!var6.isEnabled()) {
                    return false;
                } else {
                    int var4;
    ...
    public interface OnScrollChangeListener {
        void onScrollChange(SeslNestedScrollView var1, int var2, int var3, int var4, int var5);
    }

    public static class SavedState extends BaseSavedState {
        public static final Creator<SeslNestedScrollView.SavedState> CREATOR = new Creator<SeslNestedScrollView.SavedState>() {
            public SeslNestedScrollView.SavedState createFromParcel(Parcel var1) {
                return new SeslNestedScrollView.SavedState(var1);
            }

            public SeslNestedScrollView.SavedState[] newArray(int var1) {
                return new SeslNestedScrollView.SavedState[var1];
            }
        };
