...
public class CreditsPageListViewHolder extends SeslRecyclerView.ViewHolder {
    ...
    public void onBindViewHolder(CreditsListViewModel viewModel) {
        if (mIsItem)  {
            ...
            mLibIconView.setShapeAppearanceModel(mLibIconView.getShapeAppearanceModel().toBuilder().setAllCorners(CornerFamily.ROUNDED, 45.0f).build());
