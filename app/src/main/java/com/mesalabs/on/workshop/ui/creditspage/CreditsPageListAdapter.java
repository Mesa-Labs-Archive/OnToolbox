package com.mesalabs.on.workshop.ui.creditspage;
...
public class CreditsPageListAdapter extends SeslRecyclerView.Adapter<CreditsPageListViewHolder> {
    ...
    public CreditsPageListViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = viewType == 1 ? LayoutInflater.from(parent.getContext()).inflate(R.layout.mesa_tb_view_spacing_layout, parent, false) : LayoutInflater.from(parent.getContext()).inflate(R.layout.mesa_view_creditspage_item_layout, parent, false);
