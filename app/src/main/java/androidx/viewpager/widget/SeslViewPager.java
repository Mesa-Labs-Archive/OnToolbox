...
public class SeslViewPager extends ViewGroup {
    ...
    public SeslEdgeEffect mLeftEdge;
    ...
    public SeslEdgeEffect mRightEdge;
            ...
            label84: {
                if (var2 != null) {
                    ...
                    if (!var6) {
                        ...
                        LogUtils.e("ViewPager", var11.toString());
                        var5 = var4;
                        break label84;
                    }
                }
    ...
    public void initViewPager() {
        ...
        this.mLeftEdge = new SeslEdgeEffect(var1);
        this.mRightEdge = new SeslEdgeEffect(var1);
    ...
    public void setOffscreenPageLimit(int var1) {
        ...
        if (var1 < 1) {
            ...
            var3.append(1);
            LogUtils.w("ViewPager", var3.toString());
            var2 = 1;
        }
